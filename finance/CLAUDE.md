...
- 2026-06-09 — Updated launcher icon to white-on-black adaptive icon set: replaced ic_launcher_foreground.png with vector wallet-with-motion-lines design (ic_launcher_foreground.xml); set ic_launcher_background to #000000 in values/colors.xml and drawable/ic_launcher_background.xml.
