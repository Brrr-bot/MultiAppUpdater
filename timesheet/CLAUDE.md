...
- 2026-06-09 — Updated launcher icon to white-on-black adaptive icon set: replaced ic_launcher_foreground.png with vector calendar/planner design (ic_launcher_foreground.xml); set ic_launcher_background to #000000 in drawable/ic_launcher_background.xml (values/ic_launcher_background.xml was already #000000).
